...
// node_modules/.pnpm/react-image-crop@10.1.8_react@18.3.1/node_modules/react-image-crop/dist/index.js
...
var f = (s, t, e) => Math.min(Math.max(s, t), e);
var S = (...s) => s.filter((t) => t && typeof t == "string").join(" ");
var P = (s, t) => s === t || s.width === t.width && s.height === t.height && s.x === t.x && s.y === t.y && s.unit === t.unit;
function H(s, t, e, o) {
  const i = y(s, e, o);
...
var b = { capture: true, passive: false };
var v = class m extends import_react.PureComponent {
  constructor() {
    super(...arguments), this.docMoveBound = false, this.mouseDownOnCrop = false, this.dragStarted = false, this.evData = {
      ...
      clientY: 0,
      isResize: true
    }, this.componentRef = (0, import_react.createRef)(), this.mediaRef = (0, import_react.createRef)(), this.initChangeCalled = false, this.state = {
      cropIsActive: false,
  ...
  createCropSelection() {
    ...
    if (a)
      return import_react.default.createElement(
        ...
        i && import_react.default.createElement("div", { className: "ReactCrop__selection-addon", onMouseDown: (h) => h.stopPropagation() }, i(this.state)),
  ...
  render() {
    ...
    return import_react.default.createElement("div", { ref: this.componentRef, className: l, style: h }, import_react.default.createElement("div", { ref: this.mediaRef, className: "ReactCrop__child-wrapper", onPointerDown: this.onComponentPointerDown }, e), p);
  }
};
v.xOrds = ["e", "w"];
v.yOrds = ["n", "s"];
